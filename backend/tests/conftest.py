...
from backend.app.utils.database import Base # Only import Base
from backend.app.dependencies import get_db # Import get_db from dependencies
from backend.app.models import user, product, price_history, notification_queue # Import all models
...
from backend.app.scrapers.generic_scraper import GenericScraper # Import GenericScraper
from backend.app.scrapers.scraper_factory import get_scraper as original_get_scraper # Import original get_scraper
from backend.app.dependencies import get_product_scraper # Import get_product_scraper
